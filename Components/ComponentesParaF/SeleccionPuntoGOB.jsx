...
export default function SeleccionPuntoGOB() {
    ...
    const PGOB_Santo_Domingo_Este = () => {
        let PuntoGOB__GOB = document.getElementById('PuntoGOB__GOB');
        PuntoGOB__GOB.innerText = 'Punto GOB Santo Domingo Este';
    ...
    const PGOB_Santo_Doming_Norte = () => {
        let PuntoGOB__GOB = document.getElementById('PuntoGOB__GOB');
        PuntoGOB__GOB.innerText = 'Punto GOB Santo Doming Norte';
  ...
  return (
    <div className='PuntoGOB'>
        ...
        <div className='PuntoGOB__span' id='PuntoGOB__span'>
            ...
            <span onClick={PGOB_Santo_Domingo_Este}>Punto GOB Santo Domingo Este</span>
            <span onClick={PGOB_Santo_Domingo_Oeste}>Punto GOB Santo Domingo Oeste</span>
            <span onClick={PGOB_Santiago}>Punto GOB Santiago</span>
            <span onClick={PGOB_Santo_Doming_Norte}>Punto GOB Santo Doming Norte</span>
            <span className='exection2' onClick={PGOB_San_Cristóbal}>Punto GOB San Cristóbal</span>
        </div>
    </div>
  )
};
